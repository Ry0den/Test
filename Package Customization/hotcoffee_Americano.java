...
public class hotcoffee_Americano extends JFrame {
	...
	private JPanel syrupsPanel;
	private JPanel logoPanel;
	private JPanel drinkNamePanel;
	private JPanel drinkDescPanel;
	private JLabel K_Co;
	...
	private void initializeComponents() {
		...
		syrupsPanel = new JPanel();
		
		logoPanel = new JPanel();
		drinkNamePanel = new JPanel();
		drinkDescPanel = new JPanel();
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!selectedSugar.isEmpty())
					orderName.append(", ").append(selectedSugar);
