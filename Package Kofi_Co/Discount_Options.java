...
public class Discount_Options {
	...
	private JPanel createDiscountOptionsPanel() {
		...
		JButton pwdBtn = menuButton("PWD", "Discount Register");
		JButton seniorBtn = menuButton("Senior", "Discount Register");
		JButton memberBtn = menuButton("Member", "Discount Register");
